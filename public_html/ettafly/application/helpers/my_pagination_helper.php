...
function my_pagination($showUrl, $perPage = 9, $totalRows, $isJsonPagination = false) {
...
//  </ul>
    ...
    $cfg['full_tag_open'] = '<ul class="clearfix">';
    $cfg['full_tag_close'] = '</ul>';
    $cfg['prev_link'] = '<span class="fa fa-angle-left"></span>';
    $cfg['prev_tag_open'] = '<li class="prev">';
    $cfg['prev_tag_close'] = '</li>';
    $cfg['next_link'] = '<span class="fa fa-angle-right"></span>';
    $cfg['next_tag_open'] = '<li class="next">';
    $cfg['next_tag_close'] = '</li>';
    if ($isJsonPagination) {
        $cfg['cur_tag_open'] = '<li><a class="active">';
    } else {
        $cfg['cur_tag_open'] = '<li><a href="' . base_url() . $showUrl .'" class="active" style="pointer-events:none;">';
    }
