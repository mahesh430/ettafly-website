                                ...
                                <tbody>
                                    ...
                                    foreach($data as $data_view){
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions">
                                               <a href="eliteadmin/products/products/view/<?php echo $data_view->id; ?>" class="btn btn-info"> Add Products </a>
                                            </td>
                                            <td>     
                                                <?php if ($data_view->image != '') { ?>

                                                    <img src="public/images/admin/<?php echo $data_view->image; ?>" width="180px" height="130px" alt="" />
                                                    </a>
                                                <?php } else { ?>
                                                    <h4>N/A</h4>
                                                <?php } ?>
