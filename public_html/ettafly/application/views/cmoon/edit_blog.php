                    ...
                    <div class="white-box ">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url(); ?><?php echo $segment1; ?>/<?php echo $segment2 ?>/<?php echo $segment3 ?>/<?php echo $segment4; ?>_data/<?php echo $segment5; ?>" method="post" id="validation-form" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" readonly class="form-control" id="datepicker-autoclose" data-provide="datepicker" name="date" value="<?php
                                    $date_1 = $data->date;
                                    if ($date_1 != '') {
                                        echo $date = date('m/d/Y', $date_1);
                                    }
                                    ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="location" id="location" value="<?php echo $data->location; ?>">
                                </div>
                            </div>
