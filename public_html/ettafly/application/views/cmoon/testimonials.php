                                ...
                                <tbody>
                                    ...
                                    foreach($data as $data_view){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $data_view->designation; ?></td>
                                            <!--<td><?php $date_1 = $data_view->date; echo  $date = date('d/m/Y',$date_1);  ?></td>-->
                                            <td>     
                                                <?php if ($data_view->image != '') { ?>
                                                <a data-fancybox="gallery" href="<?php echo base_url(); ?>public/images/admin/<?php echo $data_view->image; ?>">
                                                        <img src="<?php echo base_url(); ?>public/images/admin/<?php echo $data_view->image; ?>" style="width: 200px; height: 300px" class="img-fluid"></a>
                                                <?php } else { ?>
                                                    <h4>N/A</h4>
                                                <?php } ?>
                                            </td>
                                            <td>     
                                                <iframe width="400" height="270"
                                                        src="https://www.youtube.com/embed/<?php echo $data_view->video; ?>">
                                                </iframe>
                                            </td>
                                            <td class="td-actions">
