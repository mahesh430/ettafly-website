...
<!--                        <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="product_id" id="product_id" value="<?php echo $segment5; ?>">
                       
                        <div class="form-group">
                            <label class="col-md-2" for="input-file-now">Image</label>
                            <div class="col-md-8">
                            <input type="file" name="images[]" id="input-file-now" multiple class="dropify" data-default-file="public/images/admin/<?php echo $data->image; ?>" />
