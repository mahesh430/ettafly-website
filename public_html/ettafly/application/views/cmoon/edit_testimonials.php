                ...
                <div class="white-box ">
                   ...
                   <hr><br><br>
                    <form class="form-horizontal" action="<?php echo base_url(); ?><?php echo $segment1; ?>/<?php echo $segment2 ?>/<?php echo $segment3 ?>/<?php echo $segment4; ?>_data/<?php echo $segment5; ?>" method="post" id="validation-form" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            <label class="col-md-2" for="designation">Designation</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="designation" id="designation" value="<?php echo $data->designation; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2" for="video">Video</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" name="description" id="description" rows="5"><?php echo $data->description; ?></textarea>
                            </div>
                        </div>
