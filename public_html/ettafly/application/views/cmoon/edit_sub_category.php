                ...
                <div class="white-box ">
                   ...
                   <hr><br><br>
                    <form class="form-horizontal" action="<?php echo base_url(); ?><?php echo $segment1; ?>/<?php echo $segment2 ?>/<?php echo $segment3 ?>/<?php echo $segment4; ?>_data/<?php echo $segment5; ?>" method="post" id="validation-form" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            <label class="col-md-2" for="sub_id">Products Category</label>
                            <div class="col-sm-8">
                                <select name="sub_id" class="form-control">
                                   <option>Select Products Category</option>
                                   <?php
                                   foreach($sub_data as $sub_data_view){
                                        ?>
                                    <option value="<?php echo $sub_data_view->id; ?>" <?php if ($sub_data_view->id == $data->sub_id) { ?> selected <?php } ?>><?php echo $sub_data_view->name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
