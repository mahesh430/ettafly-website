              ...
              <div class="flight-list">
                <div class="flight-item">
                  <div class="row align-items-center flex-row pt-4 pb-2 px-3">
                    ...
                    <div class="col-12 col-sm-2 text-center ml-auto btn-book"> <a href="confirm_details.php" class="btn btn-sm btn-primary"><i class="fas fa-shopping-cart d-block d-lg-none"></i> <span class="d-none d-lg-block">Book</span></a> </div>
                        ...
                        <div class="modal-body">
                          <div class="flight-details">
                            <div class="row mb-4">
                              ...
                              <div class="col-12 col-sm-3 col-lg-2 text-right ml-auto btn-book"> <a href="confirm_details.php" class="btn btn-sm btn-primary"><i class="fas fa-shopping-cart d-block d-lg-none"></i> <span class="d-none d-lg-block">Book</span></a> </div>
                            </div>
