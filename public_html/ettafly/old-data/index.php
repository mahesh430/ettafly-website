...
<!--          <ul class="nav nav-tabs style-2" id="myTab" role="tablist">
          ...
          <div class="tab-content bg-light shadow-md rounded rounded-top-0 px-4 pt-4 pb-2" id="myTabContent"> 
            ...
            <form id="bookingFlight" method="post" action="one_way.php">
                <div class="mb-3">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 text-center text-lg-left">
            ...
            <div class="pt-3"> <a class="mr-4" href=""><img alt="" src="images/app-store.png"></a><a href=""><img alt="" src="images/google-play-store.png"></a> </div>
          </div>
        </div>
      </div>
